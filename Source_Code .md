            ...
            if isinstance(Column_command_2, int):
                ...
                if Column_command_2 != 8 and Column_command_2 != 9:
                    ...
                    if College_option_1 == 1:
                        ...
                        if graph_main_1 == 1:
                            mp.bar(X=list_college_top, Y=Main_Table_sorted_new_1.head(top_rows_new))
                            mp.title("Graph of : Top collees v/s", )
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
                        elif graph_main_1 == 2:
                            mp.scatter(X=list_college_top, Y=Main_Table_sorted_new_1.head(top_rows_new))
                            mp.title("")
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
                        elif graph_main_1 == 3:
                            mp.plot(X=list_college_top, Y=Main_Table_sorted_new_1.head(top_rows_new))
                            mp.title("")
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
                        ...
                        if graph_main_1 == 1:
                            mp.bar(X=list_college_bottom_1, Y=Main_Table_sorted_new_1.tail(bottom_rows_new))
                            mp.title("")
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
                        elif graph_main_1 == 2:
                            mp.scatter(X=list_college_bottom_1, Y=Main_Table_sorted_new_1.tail(bottom_rows_new))
                            mp.title("")
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
                        elif graph_main_1 == 3:
                            mp.plot(X=list_college_bottom_1, Y=Main_Table_sorted_new_1.tail(bottom_rows_new))
                            mp.title("")
                            mp.xlabel("")
                            mp.ylabel("")
                            mp.show()
