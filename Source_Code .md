    ...
    try:
        ...
        if command_1 == 1:
                                    ...
                                    if isinstance(graph_input, int):
                                        if graph_input == 1:
                                            ...
                                            if College_option == 1:
                                                ...
                                                # Filter the DataFrame to only include the selected custom colleges
                                                filtered_df = Main_Table_sorted[Main_Table_sorted["Name of College"].isin(list_custom_rows)]
                                                y_values = filtered_df[list_columns[-1]]
                                                x_labels = filtered_df["Name of College"]
                                                if graph_main == 1:
            ...
            while True:
                ...
                Column_command_2 = input(
                    "Please enter the column number from the list for which you want to see the graph : ")
                ...
                if isinstance(Column_command_2, int):
                    ...
                    if Column_command_2 != 8 and Column_command_2 != 9:
                        ...
                        if College_option_1 == 1:
                            ...
                            if graph_main_1 == 1:
                                mp.bar(list_college_top, Main_Table_sorted_new_1[List_columns_new[Column_command_2 - 1]].tain(bottom_rows_new))
                                mp.title("Graph of : Top colleges vs " + List_columns_new[Column_command_2 - 1])
                                mp.xlabel("Colleges")
                                mp.ylabel(List_columns_new[Column_command_2 - 1])
                                mp.show()
                            elif graph_main_1 == 2:
                                mp.scatter(list_college_top, Main_Table_sorted_new_1[List_columns_new[Column_command_2 - 1]].tain(bottom_rows_new))
                                mp.title("Graph of : Top colleges vs " + List_columns_new[Column_command_2 - 1])
                                mp.xlabel("Colleges")
                                mp.ylabel(List_columns_new[Column_command_2 - 1])
                                mp.show()
                            elif graph_main_1 == 3:
                                mp.plot(list_college_top, Main_Table_sorted_new_1[List_columns_new[Column_command_2 - 1]].tain(bottom_rows_new))
                                mp.title("Graph of : Top colleges vs " + List_columns_new[Column_command_2 - 1])
                                mp.xlabel("Colleges")
                                mp.ylabel(List_columns_new[Column_command_2 - 1])
                                mp.show()
                            ...
                            if graph_main_1 == 1:
                                ...
                                mp.scatter(list_custom_rows_1, Main_Table_sorted_new_1[List_columns_selected[0]])
                                mp.title("")
                                mp.xlabel("")
                                mp.ylabel("")
                                mp.show()
                            elif graph_main_1 == 3:
                                mp.plot(list_custom_rows_1, Main_Table_sorted_new_1[List_columns_selected[0]])
                                mp.title("")
                                mp.xlabel("")
                                mp.ylabel("")
                                mp.show()
